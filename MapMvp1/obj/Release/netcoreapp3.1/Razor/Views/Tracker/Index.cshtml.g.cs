#pragma checksum "C:\Users\sachi\source\repos\MapMvp1\MapMvp1\Views\Tracker\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "ed52c59862d9212b3c870f2370ed97f10cda3169"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"ed52c59862d9212b3c870f2370ed97f10cda3169", @"/Views/Tracker/Index.cshtml")]
      ...
      //  import { onMounted } from ""../../wwwroot/js/LocalVue"";
        ...
        const App = {
            setup() {
                ...
                connection.on(""ReceiveLocation"", function (latitude, longitude, dateTime, vehicleId) {
                    console.log("" Data Received "");

                    console.log(latitude + "" "" + longitude + """" + dateTime);
                    console.log(""------------------------------"");

                    getNewValues(latitude, longitude, dateTime);
                    console.log(""------------------------------"");

                   drawMarkerOnMap(latitude, longitude, dateTime, vehicleId)
                ...
                const drawMarkerOnMap = (latitude, longitude, dateTime, vehicleId) => {
                    ...
                    if (typeof vehicle != undefined) {
                       ...
                       ");
                WriteLiteral(@" const newMarker = new L.marker([latitude, longitude]);
